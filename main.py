...
def main() -> bool:
    '''
        Bootstraps and runs the gen_named_pipe with required adapters.

        :return: True if successful, False otherwise.
        :exceptions: None
    '''
    gen_named_pipe: GenNamedPipe = GenNamedPipe(GenNamedPipeBundleFactory.create_bundle())

    return gen_named_pipe.process()


if __name__ == '__main__':
    '''
        Entry point for gen_named_pipe execution.
