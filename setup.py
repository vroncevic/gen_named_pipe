...
"""
 ...
 Copyright
     ...
     gen_named_pipe is free software: you can redistribute it and/or
     modify it under the terms of the GNU General Public License as published
     by the Free Software Foundation, either version 3 of the License, or
     (at your option) any later version.
     gen_named_pipe is distributed in the hope that it will be useful,
...
setup(
    name='gen_named_pipe',
    version='1.0.6',
    description='Generating Named Pipe Modules',
    author='Vladimir Roncevic',
    author_email='elektron.ronca@gmail.com',
    url='https://vroncevic.github.io/gen_named_pipe',
    license='GPL 2020 Free software to use and distributed it.',
    long_description=LONG_DESCRIPTION,
    long_description_content_type='text/markdown',
    keywords='Unix, Linux, Development, Named Pipe, Modules',
    platforms='POSIX',
    ...
    package_data={
        'gen_named_pipe': [
            ...
            'conf/template/posix/np_close.template',
            'conf/template/posix/np_make.template',
            'conf/template/posix/np_open.template',
            'conf/template/posix/np_read.template',
            'conf/template/posix/np_write.template',
            'log/gen_named_pipe.log'
        ]
    },
    data_files=[(
        '/usr/local/bin/', [
            '{0}{1}'.format(TOOL_DIR, 'run/gen_named_pipe_run.py')
        ]
    )]
)
