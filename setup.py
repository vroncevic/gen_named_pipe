...
setup(
    name='gen_named_pipe',
    version='1.2.0',
    description='Generating named pipe project',
    ...
    keywords='Unix, Linux, Development, Named pipe, FIFO, C, C++, generator',
    platforms='POSIX',
    classifiers=PYP_CLASSIFIERS,
    packages=find_packages(exclude=['tests', 'tests.*', '*.*.pyc', '*.pyo']),
    install_requires=['ats-utilities'],
    package_data={'gen_named_pipe': find_package_data('gen_named_pipe')}
)
