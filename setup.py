...
Info
    Defines setup for tool gen_named_pipe.
'''
...
setup(
    ...
    packages=['gen_named_pipe', 'gen_named_pipe.pro'],
    install_requires=['ats-utilities'],
    package_data={
        'gen_named_pipe': [
            'py.typed',
            f'{CONF}/gen_named_pipe.logo',
            f'{CONF}/gen_named_pipe.cfg',
            f'{CONF}/gen_named_pipe_util.cfg',
            f'{CONF}/project.yaml',
            ...
            f'{LOG}/gen_named_pipe.log'
        ]
    },
    data_files=[(
        '/usr/local/bin/', [
            f'{TOOL_DIR}run/gen_named_pipe_run.py'
        ]
    )]
)
