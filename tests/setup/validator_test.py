...
Module
    validator_test.py
Info
    Unit tests for GenNamedPipeBundleValidator class.
'''
...
class TestGenNamedPipeBundleValidator(unittest.TestCase):
    ...
    def test_validate_bundle_none(self) -> None:
        with self.assertRaises(Exception):
            GenNamedPipeBundleValidator.validate(None)

    def test_validate_bundle_invalid_type(self) -> None:
        with self.assertRaises(Exception):
            GenNamedPipeBundleValidator.validate("invalid_bundle")
    ...
    def test_is_valid_success(self) -> None:
        ...
        self.assertTrue(GenNamedPipeBundleValidator.is_valid(bundle))

    def test_is_valid_failure(self) -> None:
        self.assertFalse(GenNamedPipeBundleValidator.is_valid(None))
        self.assertFalse(GenNamedPipeBundleValidator.is_valid("invalid"))
