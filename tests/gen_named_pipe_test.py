...
Info
    Defines class GenNamedPipeTestCase with attribute(s) and method(s).
    Creates test cases for checking functionalities of GenNamedPipe.
Execute
    python3 -m unittest -v gen_named_pipe_test
'''
...
class GenNamedPipeTestCase(TestCase):
    '''
        Defines class GenNamedPipeTestCase with attribute(s) and method(s).
        Creates test cases for checking functionalities of GenNamedPipe.
        GenNamedPipe unit tests.
    ...
    def test_default_create(self) -> None:
        ...
        generator: GenNamedPipe = GenNamedPipe()
    ...
    def test_missing_args(self) -> None:
        ...
        sys.argv.insert(1, 'gen_named_pipe_run.py')
        generator: GenNamedPipe = GenNamedPipe()
