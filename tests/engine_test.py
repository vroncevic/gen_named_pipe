...
Module
    test_engine.py
Info
    Unit tests for GenNamedPipe engine.
'''
...
from gen_named_pipe.engine import GenNamedPipe
...
class TestGenNamedPipe(unittest.TestCase):
    ...
    def test_engine_process_success(self) -> None:
        ...
        mock_base = BaseBundleFactory.create_bundle(
            options=BaseBundleOptions(
                info_file='gen_named_pipe/infrastructure/config/gen_named_pipe.cfg',
                use_generator=True,
    ...
    @patch('gen_named_pipe.setup.validator.GenNamedPipeBundleValidator.validate')
    ...
    def test_cli_bundle_factory(self) -> None:
        from gen_named_pipe.infrastructure.cli.setup.factory import CLIBundleFactory
