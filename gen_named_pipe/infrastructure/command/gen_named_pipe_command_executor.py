...
Info
    Defines GenNamedPipeCommandExecutor class.
'''
...
class GenNamedPipeCommandExecutor:
    '''
        Command executor strategy for generating named_pipe project files.
        ...
        It defines:
            ...
            :methods:
                ...
                | __str__ - Returns the GenNamedPipeCommandExecutor as string representation.
    '''
    ...
    def __str__(self) -> str:
        '''
            Returns the GenNamedPipeCommandExecutor as string representation.

            :return: The GenNamedPipeCommandExecutor as string representation.
        '''
        return to_str(self)
