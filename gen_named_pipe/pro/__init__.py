...
Info
    Defines class NamedPipe with attribute(s) and method(s).
    Generates Named PIPE by templates and parameters.
'''
...
class NamedPipe(FileCheck, ProConfig, ProName):
    '''
        Defines class NamedPipe with attribute(s) and method(s).
        Generates Named PIPE by templates and parameters.
        ...
        It defines:
            ...
            :attributes:
                ...
                | _writer - Writer API.
            :methods:
                | __init__ - Initials NamedPipe constructor.
                | get_reader - Gets template reader.
                | get_writer - Gets template writer.
                | gen_module - Generates Named PIPE.
    '''

    _GEN_VERBOSE: str = 'GEN_NAMED_PIPE::PRO::NAMED_PIPE'
    _PRO_STRUCTURE: str = '/../conf/project.yaml'

    def __init__(self, verbose: bool = False) -> None:
        '''
            Initials NamedPipe constructor.
