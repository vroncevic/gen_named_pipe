...
Info
    Validator for the gen_named_pipe bundle options.
'''
...
class GenNamedPipeBundleOptionsValidator:
    '''
        Validator for the gen_named_pipe bundle options.
    ...
    @classmethod
    def validate(cls, options: GenNamedPipeBundleOptions) -> None:
        '''
            Validates the gen_named_pipe bundle options.

            :param options: The gen_named_pipe bundle options to be validated.
            :exceptions:
        ...
        '''
        ctx: str = 'gen_named_pipe_bundle_options_validator::validate(...)'
        msg_options_none: str = 'the gen_named_pipe bundle options must be provided'
        msg_options_istype: str = 'the gen_named_pipe bundle options must be a Mapping'

        not_none(options, ctx, msg_options_none)
        istype(options, Mapping, ctx, msg_options_istype)

        for attr_name, expected_type in GenNamedPipeBundleKeys.get_option_to_type().items():
