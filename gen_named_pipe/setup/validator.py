...
Info
    A validator for the gen_named_pipe bundle.
'''
...
class GenNamedPipeBundleValidator:
    '''
        A validator for the gen_named_pipe bundle.
        ...
        It defines:
            ...
            :methods:
                | validate - Validates the gen_named_pipe bundle.
                | is_valid - Checks if the gen_named_pipe bundle is valid.
    '''

    @classmethod
    def validate(cls, bundle: GenNamedPipeBundle) -> None:
        '''
            Validates the gen_named_pipe bundle.

            :param bundle: The gen_named_pipe bundle to be validated.
            :exceptions:
        ...
        '''
        ctx: str = 'gen_named_pipe_bundle_validator::validate(...)'
        msg_bundle_none: str = 'the gen_named_pipe bundle must be provided'
        msg_bundle_istype: str = 'the gen_named_pipe bundle must be an instance of GenNamedPipeBundle'
        ...
        istype(bundle, GenNamedPipeBundle, ctx, msg_bundle_istype)
    ...
    @classmethod
    def is_valid(cls, gennamedpipebundle: GenNamedPipeBundle) -> bool:
        '''
            Checks if the gennamedpipebundle is valid.

            :param gennamedpipebundle: The gennamedpipebundle to be checked.
            :return: True if valid, False otherwise.
        '''
        try:
            cls.validate(gennamedpipebundle)
            return True
