...
Info
    GenNamedPipe bundle dependencies for the gen_named_pipe bundle.
'''
...
class GenNamedPipeBundleDependencies(TypedDict):
    '''
        GenNamedPipe bundle dependencies for the gen_named_pipe bundle.
        ...
        It defines:
            ...
            :attributes:
                | base - The base bundle with the base components for the gen_named_pipe bundle.
                | service - The service orchestrating the gen_named_pipe's execution for the gen_named_pipe bundle.
                | subprocessor - The adapter executing the gen_named_pipe's sub-processes for the gen_named_pipe bundle.
                | cli - The command-line interface adapter for the gen_named_pipe bundle.
    '''
