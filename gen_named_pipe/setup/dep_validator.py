...
Info
    Validator for the gen_named_pipe bundle dependencies.
'''
...
class GenNamedPipeBundleDependenciesValidator:
    '''
        Validator for the gen_named_pipe bundle dependencies.
    ...
    @classmethod
    def validate(cls, dependencies: GenNamedPipeBundleDependencies) -> None:
        '''
            Validates the gen_named_pipe bundle dependencies.

            :param dependencies: The gen_named_pipe bundle dependencies to be validated.
            :exceptions:
        ...
        '''
        ctx: str = 'gen_named_pipe_bundle_dependencies_validator::validate(...)'
        msg_dependencies_none: str = 'the gen_named_pipe bundle dependencies must be provided'
        msg_dependencies_istype: str = 'the gen_named_pipe bundle dependencies must be a Mapping'

        not_none(dependencies, ctx, msg_dependencies_none)
        istype(dependencies, Mapping, ctx, msg_dependencies_istype)

        for attr_name, expected_type in GenNamedPipeBundleKeys.get_dependency_to_type().items():
