...
Info
    GenNamedPipe bundle options for the gen_named_pipe bundle.
'''
...
class GenNamedPipeBundleOptions(TypedDict):
    '''
        GenNamedPipe bundle options for the gen_named_pipe bundle.
        ...
        It defines:
            ...
            :attributes:
                | info_file - The info file path for the gen_named_pipe bundle.
    '''
