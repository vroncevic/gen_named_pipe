...
.. |documentation status| image:: https://readthedocs.org/projects/gen-named_pipe/badge/?version=latest
   :target: https://gen-named_pipe.readthedocs.io/en/latest/?badge=latest
...
* Automatically scaffolds C/C++ Named Pipe (FIFO) projects.
...
* `gen_named_pipe.readthedocs.io <https://gen-named_pipe.readthedocs.io>`_
* `www.python.org <https://www.python.org/>`_

👥 Contributing
---------------

`Contributing to gen_named_pipe <https://github.com/vroncevic/gen_named_pipe/blob/dev/CONTRIBUTING.md>`_
